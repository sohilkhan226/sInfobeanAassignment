...
# If international, then check OTP verification. If verified, allow; otherwise block. If location is domestic, then check if amount is at least 50000. 
# If yes, check account age. If account age is at least 2 years, allow;
# otherwise flag. If amount is less than 50000, allow. If transaction amount is less than 10000, 
