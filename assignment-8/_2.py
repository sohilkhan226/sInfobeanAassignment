...
# If general, admit; otherwise admit with scholarship. If entrance score is less than 80,
#  then check if marks are 85 or above. If yes, admit under management quota; otherwise reject. 
